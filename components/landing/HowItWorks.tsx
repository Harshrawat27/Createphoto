...
const steps = [
  {
    ...
    title: 'Upload Photos',
    description:
      'Upload 3-5 varied selfies or portraits. Good lighting and different angles help the AI learn best.',
  },
  {
    icon: <Cpu className='w-8 h-8' />,
    title: 'Train Model',
    description:
      'Our powerful GPU cluster processes your images to create a dedicated LoRA model of your likeness in ~5 minutes.',
  },
  {
    icon: <Download className='w-8 h-8' />,
    title: 'Generate & Download',
    description:
      'Use text prompts to generate photos of yourself in any scenario. Download high-res images instantly.',
  },
];
