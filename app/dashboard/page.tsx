    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">You have 150 credits remaining.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-xl border border-border bg-card shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">My Personal Model v1</p>
                </div>
            </div>
            <Link href="/dashboard/models" className="text-sm text-primary hover:underline flex items-center gap-1">
        ...
        <div className="p-6 rounded-xl border border-border bg-card shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link href="/dashboard/gallery" className="text-sm text-primary hover:underline flex items-center gap-1">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="aspect-[2/3] rounded-lg bg-secondary/20 animate-pulse" />
            ))}
        </div>
      </div>
    </div>
